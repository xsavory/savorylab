      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            SavoryLab React + Appwrite Template
          </h1>
          <p className="text-lg mb-6 max-w-2xl mx-auto text-blue-100">
            Internal template for rapid React development with Vite, TypeScript, Tailwind CSS 4, and Appwrite for authentication & database.
          </p>
